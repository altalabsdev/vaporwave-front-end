          ...
          <div className="content">
                  ...
                  <ul className="list-style-none">
                    <li>
                      <p className="body-text">
                        ...
                        you reside and you have legal capacity to enter into these Terms and be bound by them;
                      </p>
                    </li>
                    <li>
                      <p className="body-text">
                    ...
                    <li>
                      <p className="body-text">
                        ...
                        or the United Nations, including without limitation the US Office of Foreign Asset Control
              ...
              <ul className="list-style-none">
                <li>
                  ...
                  <ul className="list-style-none">
                    ...
                    <li>
                      <p className="body-text">
                        1.2.8. to the fullest not prohibited by Applicable Law, we owe no fiduciary duties or
                        liabilities to you or any other party, and that to the extent any such duties or liabilities may
                        exist at law or in equity, you hereby irrevocably disclaim, waive, and eliminate those duties
                        and liabilities;
                      </p>
                    ...
                    <li>
                      <p className="body-text">
                        ...
                        or is authorized to do so, and if you experience a problem with any transactions in digital
                        assets using the Site or the Interface, then you bear the entire risk.
                      </p>
                    </li>
                  </ul>
                </li>
            ...
            <div className="section">
              ...
              <ul className="list-style-none">
                ...
                <li>
                  <p className="body-text">
                    6.3. You understand that the Aurora blockchain remains under development, which
                    ...
                    the Aurora blockchain is variable and may increase at any time causing impact to any
                ...
                <li>
                  <p className="body-text">
                    6.4. Transactions entered into in connection with the Interface are irreversible, final and there
                    are no refunds. You acknowledge and agree that you will access and use the Interface at your own
                    risk.
                  </p>
                </li>
                <li>
                  ...
                  <ul className="list-style-none">
                    ...
                    <li>
                      <p className="body-text">
                        ...
                        trading; (e) fictitious transactions; (f) pre-arranged or non-competitive transactions; (g)
                        cornering or attempted chimering;
                      </p>
                    </li>
                    <li>
                      <p className="body-text">
                        7.1.4. uploading or transmitting viruses, worms, Trojan horses, time bombs, cancel bots,
                        spiders, malware or any other type of malicious code that will or may be used in any way that
                        will affect the functionality or operation of the Site or the Interface;
                      </p>
                    </li>
                    <li>
                      <p className="body-text">
            ...
            <div className="section">
              ...
              <p className="body-text">
                ...
                U.S. Commodity Futures Trading Commission (“CFTC”), no US Person may enter into Perpetual Contracts
                using the Interface.
              </p>
              <p className="body-text">
            ...
            <div className="section">
              ...
              <p className="body-text">
                ...
                indemnification by you. You agree to cooperate with our defense of any claim. You will not in any event
                settle any claim without
              </p>
            </div>
            <div className="section">
              ...
              <p className="body-text">
                ...
                to resolve all Disputes by binding arbitration. The arbitration shall be held on a confidential basis
                before a single arbitrator, who shall be selected pursuant to the CIMA rules. The arbitration will be
                held in Madrid, Spain, unless you and we both agree to hold it elsewhere. Unless we agree otherwise, the
              ...
              <ul className="list-style-none">
                ...
                <li>
                  <p className="body-text">
                    ...
                    other provision which by law or by its nature should survive: Sections 3 through 13. .{" "}
                  </p>
                </li>
                <li>
                  <p className="body-text">
                ...
                <li>
                  <p className="body-text">
                    13.4. We will have no responsibility or liability for any failure or delay in performance of the
                ...
                <li>
                  <p className="body-text">
                    13.5. You may not assign or transfer any right to use the Site or the Interface, or any of your
                    rights or obligations under these Terms, without our express prior written consent, including by
                    operation of law or in connection with any change of control. We may assign or transfer any or all
                    of our rights or obligations under these Terms, in whole or in part, without notice or obtaining
