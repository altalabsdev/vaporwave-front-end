      ...
      <div className="default-container Page page-layout">
        <div>
          <div className="Page-title-section center">
            <div className="Page-title">VWAVE Referral Program</div>
          ...
          <div className="content">
            <div className="section">
              <p className="body-text">
                Our greetings and welcome to VWAVE.io (“we” “us,” or “our”), the informational resource for VWAVE
                Protocol.
              </p>
              <p className="body-text">
                VWAVE.io provides information and resources about the fundamentals of the decentralized non-custodial
                protocol called the VWAVE Protocol (the “VWAVE Protocol”, “Protocol” or “VWAVE DApp”).
              </p>
              <p className="body-text">
                ...
                Affiliate”), explains the terms and conditions by which you may use the VWAVE Referral Program
            ...
            <div className="section">
              ...
              <p className="body-text">
                The Referral Program allows you to provide a platform for advertising the VWAVE DApp thereby driving
                traffic to it, whereby you may earn a portion of the revenue generated (“Rebates”) if a person that is
                not you (“Trader”, “Referred User”) trades in the VWAVE DApp after being referred to it from an
                hyperlink (“Link”) or manually input code (“Referral Code”). The Trader will benefit from a fee discount
                (“Discount”) associated with the Referrer's tier.
              </p>
              <p className="body-text">
                After being referred to the VWAVE DApp from a Link, the Trader's browser will save your Referral Code
                and it will be assigned to the Trader on his first trade.
              </p>
              <p className="body-text">
            ...
            <div className="section">
              ...
              <p className="body-text">
                As an Affiliate, VWAVE DApp provides you with the Links and Referral Codes necessary to promote the
                VWAVE Protocol. You acknowledge and agree it is your sole responsibility to indicate your correct
                Referral Code. You may promote the VWAVE Protocol offers in any manner you choose unless it misleads
                someone about the VWAVE Protocol.
              </p>
              <p className="body-text">
              ...
              <p className="body-text">
                You may be excluded from the Referral Program, in accordance with the directives of the VWAVE
            ...
            <div className="section">
              ...
              <p className="body-text">
                VWAVE.io is under no obligation whatsoever for Rebates or Discounts to any Referrer or Trader. Rebates
                and Discounts are handled in accordance with the directives of the VWAVE tokenholders.
              </p>
              <p className="body-text">
            ...
            <div className="section">
              ...
              <p className="body-text">
                Under no circumstances VWAVE.io shall be liable for any direct, indirect, incidental, punitive, special,
              ...
              <p className="body-text">
                With respect to VWAVE.io, as well as the contractors, agents, employees, officers, directors,
                ...
                for third party claims relating to or arising under these Terms, the service(s) provided by VWAVE.io, or
                your use of the service(s) provided by VWAVE.io, including, without limitation, infringement by you, or
                by anyone else using such service(s) we provide to you, of any intellectual property or other
                proprietary right of any person or entity, or from the violation of any of our operating rules or
                policies relating to the service(s) provided. When we may be involved in a suit involving a third party
                and which is related to our service(s) to you under these Terms, we may seek written assurances from you
                in which you promise to defend, indemnify and hold us harmless from the costs and liabilities described
                in this paragraph. Such written assurances may include, in our sole discretion, the posting of a
                performance bond(s) or other guarantees reasonably calculated to guarantee payment. Your failure to
                provide such assurances may be considered by us to be a breach of these Terms by you. The terms of this
                paragraph will survive any termination or cancellation of the Terms.
              </p>
            </div>
            <div className="section">
              ...
              <p className="body-text">
                ...
                agreement between you and VWAVE.io with respect to the subject matter of these Terms, and supersede any
            ...
            <div className="section">
              ...
              <p className="body-text">
                The Referral Program runs independently from VWAVE.io, and it is determined by the tokenholders of
                VWAVE. Due to this from time to time and with or without prior notice to you, the Referral Program could
                be subject to modifications, suspensions or disabilities, in whole or in part, for any reason
                whatsoever. VWAVE.io will not be liable for any losses suffered by you resulting from any modification
                to the Referral Program or from any modification, suspension, or termination, for any reason, of your
                access to all or any portion of the Interface or the Protocol.
              </p>
              <p className="body-text">
                VWAVE.io may revise these Terms from time to time. We will notify you by updating the date at the top of
                the Terms and by maintaining a current version of the Terms. The most current version of the Terms,
                which will always be at https://vaporwave.farm/referral-terms. All modifications will be effective when they are
            ...
            <div className="section">
              ...
              <p className="body-text">
                ...
                these Terms unenforceable or invalid as a whole. VWAVE.io will amend or replace such provision with one
            ...
            <div className="section">
              ...
              <p className="body-text">
                ...
                or in connection with any change of control. VWAVE.io may assign or transfer any or all of our rights or
            ...
            <div className="section">
              ...
              <p className="body-text">
                ...
                having or claiming jurisdiction over VWAVE.io, the Protocol, or of any department, agency, commission,
