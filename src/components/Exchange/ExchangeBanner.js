  ...
  return (
    <div className="ExchangeBanner">
      <p className="ExchangeBanner-text">
        Trade on Vaporwave and win <span className="ExchangeBanner-price">$250.000</span> in prizes! Live until November
        30th,{" "}
        <a
          href="https://medium.com/@vaporwave.farm/gmx-trading-competition-win-250-000-usd-in-prizes-1346504b96f6"
          target="_blank"
